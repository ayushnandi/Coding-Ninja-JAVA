...
For a given two-dimensional integer arraylist of size (N x M), print the arraylist in a sine wave order, i.e, print the first column top to bottom, next column bottom to top and so on.
Input format 
...
Output format 
For each test case, print the elements of the two-dimensional arraylist in the sine wave order in a single line, separated by a single space.
