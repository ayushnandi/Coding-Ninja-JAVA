...
Input format 
The first line contains an Integer 'N', which denotes the size of the arraylist.

The second line contains 'N' single space-separated integers representing the elements in the arraylist.

The third line contains the value of 'target' to be searched for in the arraylist.
Output Format 
